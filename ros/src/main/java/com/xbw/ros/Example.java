...
public class Example {
    ...
    public static void testService(ROSBridgeClient client) {
        try {
            ...
            Service<com.xbw.ros.rosapi.message.Service, Type> serviceTypeService =
                    new Service<com.xbw.ros.rosapi.message.Service, Type>("/rosapi/service_type",
            ...
            com.xbw.ros.Topic<Log> logTopic = 
                    new com.xbw.ros.Topic<Log>("/rosout", Log.class, client);
            logTopic.verify();
    ...
    public static void testTopic(ROSBridgeClient client) {
        com.xbw.ros.Topic<Clock> clockTopic = new com.xbw.ros.Topic<Clock>("/clock", Clock.class, client);
